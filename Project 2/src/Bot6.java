...
public class Bot6 {
    ...
    public static void add_candidate_child_extend(Ship ship, double[][] prob_table, Coordinate parent, Queue<Coordinate> queue){
        ...
        if(parent.getRow()-1 > -1){
            ...
            if(ship.getHashPath().containsKey(String.format("%d%d", top_cell.getRow(), top_cell.getCol()))){
                // queue.add(top_cell);
                list[0] = top_cell;
            }   
        }
        ...
        if(parent.getRow()+1 < prob_table.length){
            ...
            if(ship.getHashPath().containsKey(String.format("%d%d", bottom_cell.getRow(), bottom_cell.getCol()))){
        ...
        if(parent.getCol()-1 > -1){
            ...
            if(ship.getHashPath().containsKey(String.format("%d%d", left_cell.getRow(), left_cell.getCol()))){
                // queue.add(left_cell);
                list[2] = left_cell;
            }  
        }
        ...
        if(parent.getCol()+1 < prob_table[parent.getRow()].length){
            ...
            if(ship.getHashPath().containsKey(String.format("%d%d", right_cell.getRow(), right_cell.getCol()))){
    ...
    public static int run_bot6(Ship ship){
        ...
        // run bot6 until both leaks is plugged
    ...
    public static int run_bot6_demo(Ship ship){
        // get probablity of containing leak for each cell
        double[][] prob_table = init_leak_prob_table(ship);
